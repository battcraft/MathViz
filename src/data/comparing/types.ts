/**
 * Level-Specific Content Types for Comparing Numbers Topic
 *
...
export interface ConceptScreen {
  id: string;
  /** Screen title (e.g., "💡 Greater Than, Less Than: Crocodile Mouth Rule!") */
  title: string;
...
export interface SubtopicContent {
  /** Subtopic ID (e.g., "compare_basics") */
  id: string;
  /** Display name */
  name: string;
