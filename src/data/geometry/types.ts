/**
 * Level-Specific Content Types for MathsGuru AI
 *
 * These types support the restructured content system where each difficulty
 * level (Beginner/Intermediate/Expert) has its own unique content.
 */
...
export interface ConceptScreen {
  id: string;
  /** Screen title (e.g., "💡 Bindu (Point) is a Zero-Dimensional Hero!") */
  title: string;
